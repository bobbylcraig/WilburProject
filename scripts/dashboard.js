				...
				success: function(data) {
					...
					$(document).ready(function(){
						...
						$('.event-edit-select').editable(function(value, settings) {
							...
							data	  : "{'Event':'Event','Performance':'Performance','Conference':'Conference','Travel':'Travel','Athletic':'Athletic','Food':'Food','Office Supplies/Printing/Ads':'Office Supplies/Printing/Ads','Capital Purchase':'Capital Purchase','Misc':'Misc', 'selected':'Event'}",
							type      : "select",
							submit    : 'OK',
							onblur	  : "submit",
							width: "75%",
