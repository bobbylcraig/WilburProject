        ...
        data: [
            ...
            if($requested_vs_allocated_org) {
                foreach($requested_vs_allocated_org as $hmm) {
                    $yearName = dbQuery("SELECT year_name FROM year WHERE year_id = " . $hmm['year_id'] . ";")[0]['year_name'];
